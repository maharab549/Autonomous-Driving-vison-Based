...
if __name__ == "__main__":
    ...
    PLUGIN_LIBRARY = "/home/jetson/Desktop/ai_control-FULL-3.0/src/opencv_detection/scripts/yolov5/libmyplugins.so"
    engine_file_path = "/home/jetson/Desktop/ai_control-FULL-3.0/src/opencv_detection/scripts/yolov5/best.engine"
    ...
    categories = ['bulbasaur', 'pikachu', 'squirtle']
    ...
    try:
        while 1:
            ...
            if (len(result_classid) != 0):
                cls_id, area, score = get_max_area(result_boxes, result_classid,result_scores)
